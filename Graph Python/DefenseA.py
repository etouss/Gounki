...
canvas.itemconfig(abscise, text="Defence")

ordonnee = canvas.create_text(50,10,width = 500)
canvas.itemconfig(ordonnee, text="Victoire")

text = canvas.create_text(20+1.2*200,590,width = 50)
canvas.itemconfig(text, text="1,2")
...
for i in range(0,528):
  ...
  armeeA = float(string[50:58])
  string = fichier.readline()
  string = fichier.readline()
  victoireA = int(string[4:8])

  canvas.create_line(armeeA*200+20-3,1180-victoireA*2-3,armeeA*200+20+2,1180-victoireA*2+3,)
  canvas.create_line(armeeA*200+20-3,1180-victoireA*2+3,armeeA*200+20+3,1180-victoireA*2-3,)
  string = fichier.readline()
  string = fichier.readline()
  string = fichier.readline()
